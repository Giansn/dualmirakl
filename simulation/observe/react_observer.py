...
async def _exec_interview_agent(
    ...
    from simulation.core.agents_impl import resilient_agent_turn
...
class ReactObserver:
    ...
    def __init__(
        ...
        from simulation.config.legacy_roles import AGENT_ROLES
    ...
    async def analyse(
        ...
        """
        from simulation.core.agents_impl import resilient_agent_turn
        from simulation.core.state import _format_stats
        from simulation.core.event_stream import TOOL_USE, OBSERVATION, COMPLIANCE
