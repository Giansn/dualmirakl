...
class GPUHarmony:
    ...
    def __init__(
        ...
        *,
        ...
        if _adaptive:
            try:
                from simulation.gpu.monitor import GPUMonitor
    ...
    async def _generate_stimulus(self, tick: int):
        ...
        from simulation.core.event_stream import STIMULUS, COMPLIANCE
    ...
    async def _score_worker(self, n_ticks: int):
        ...
        from simulation.core.state import ObsEntry
        from simulation.core.event_stream import RESPONSE, SCORE
    ...
    async def _run_observer(self, tick: int, ivs_before: int):
        ...
        """
        from simulation.core.event_stream import OBSERVATION, INTERVENTION as EV_INTERVENTION
    ...
    def _rebalance_and_signal(self, tick: int, ivs_before: int):
        ...
        if self._balancer:
            ...
            try:
                from simulation.core.event_stream import SCORE
